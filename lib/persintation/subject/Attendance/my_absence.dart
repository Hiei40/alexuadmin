...
class YourAbsence extends StatelessWidget {
  const YourAbsence({Key? key,this.id}) : super(key: key);
  final String ? id;
  @override
    ...
    return Scaffold(
      ...
      body: BlocBuilder<SubjectCubit,SubjectState>(
          builder: (context,state) {
            return state is AbsenceLoadState || cubit.allIdAbsence.isEmpty ?  Center(child: CircularProgressIndicator(),) : SingleChildScrollView(
              child: Padding(
