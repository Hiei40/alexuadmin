                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: (index + 1) % 2 == 0
                            ? ColorManger.main_color
                            : ColorManger.secondary_color,
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage(
                                      MainList.imageListSubjectInfo[index]),
                          ...
                          Text(MainList.nameListSubjectInfo(context)[index],
                              style: GoogleFonts.inter(
                                fontSize: 20,
                                fontWeight: FontWeight
                                    .w500, // Corrected from FontWeight:FontWeight.w500
                                color: Colors.white,
                              )),
                        ],
                      ),
