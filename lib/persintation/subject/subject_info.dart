...
class SubjectInfo extends StatelessWidget {
 ...
 final String ?Level;
  ...
  Widget build(BuildContext context) {
    ...
    List Subject=[Attendance(Name:  name.toString(),),Feedbacks(Subject: name.toString(),),Progress(level: Level.toString(), subject: name.toString(),),Survey(subject: name.toString(),)];
    return Scaffold(
      appBar:  AppBar(
        title: Text(name!),
      ),
