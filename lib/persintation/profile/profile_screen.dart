...
//                 body:FirebaseAuth.instance.currentUser!.uid, Controller: null ,),
//               ProfileCard(title: 'Email',
//                 body:FirebaseAuth.instance.currentUser!.email, Controller: null,),
//               ProfileCard(title: 'Department',
//                 body:cubit.data["department"], Controller: null ,),
//               ProfileCard(title: 'Level',
//                 body:cubit.data["level"], Controller: null ,),
//               ProfileCard(title: 'CGPA',
//                 body:cubit.data["CGPA"], Controller: null ,),
//             ],
//           ),
//         );
//       }),
