...
class S {
  ...
  /// `Connect with Peers`
  String get Connect_with_Peers {
    return Intl.message(
      'Connect with Peers',
      name: 'Connect_with_Peers',
      desc: '',
      args: [],
    );
  }
  ...
  String get Seamless_Registration {
    return Intl.message(
      'Seamless Registration',
      name: 'Seamless_Registration',
      desc: '',
      args: [],
    );
  }
  ...
  String get Monitoryouracademic {
    return Intl.message(
      'Monitor your academic journey with real-time updates on grades,attendance,and more.',
      name: 'Monitoryouracademic',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Please write your FeedBack about the Subject or the Instructor`
  String get ifthere {
    return Intl.message(
      'Please write your FeedBack about the Subject or the Instructor',
      name: 'ifthere',
  ...
  String get AddyourAccounment {
    return Intl.message(
      'Please add the announcement you\n would like to announce to students',
      name: 'AddyourAccounment',
      desc: '',
      args: [],
    );
  }
